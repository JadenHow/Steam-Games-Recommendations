...
GAME_COLOUR = 'rgb(89, 205, 105)'
TAG_COLOUR = 'rgb(105, 89, 205)'
GENRE_COLOUR = 'rgb(30, 30, 30)'
CATEGORY_COLOUR = 'rgb(100, 100, 100)'
DEVELOPER_COLOUR = 'rgb(200, 200, 100)'
KIND_COLOUR_DICT = {"game": GAME_COLOUR, "tag": TAG_COLOUR, "genre": GENRE_COLOUR,
                    "category": CATEGORY_COLOUR, "developer": DEVELOPER_COLOUR}
...
def visualize_graph(graph: a3_part1.Graph,
    ...
    colours = [KIND_COLOUR_DICT[kind] for kind in kinds]
